# Generated by Django 3.0.8 on 2022-04-16 09:44
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('transport', '0004_auto_20220416_1105'),
    ]
    ...
    operations = [
        migrations.AddField(
            model_name='order',
            name='profit',
            field=djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0'), default_currency='VND', max_digits=10, verbose_name='profit'),
        ),
        migrations.AddField(
            model_name='order',
        ...
        migrations.AlterField(
            model_name='order',
            name='date_ended',
            field=models.DateTimeField(default=datetime.datetime(2022, 4, 16, 16, 44, 1, 447504), null=True, verbose_name='date ended'),
        ),
        migrations.AlterField(
            model_name='order',
            name='date_started',
            field=models.DateTimeField(default=datetime.datetime(2022, 4, 16, 16, 44, 1, 447504), null=True, verbose_name='date started'),
        ),
        migrations.AlterField(
            model_name='vehicle',
            name='date_register',
            field=models.DateTimeField(default=datetime.datetime(2022, 4, 16, 16, 44, 1, 446504), null=True, verbose_name='date register'),
        ),
    ]
